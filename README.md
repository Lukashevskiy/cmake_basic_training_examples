...
что бы запустить необходимо просто скачать себе реп (понятия не имею зачем вам этот репозиторий, тут просто выводиться в консоль hello_world! и еще из этого собрана библиотека)
и прописать 
```
